export default {
  ...
  labPing: "Ping",
	labIP: "IP",
  labStats: "Stats Info",
  labLocation: "Location Info",
  labNetwork: "Network Info",
  labIdentity: "Identity Info",
  labDate: "Date",
  labReason: "Reason", 
  labBanPlayerList: "Banned Players List", 
  ...
  msgUnbanComplete: "Unban complete.",
  msgUnbanFail: "Unban failed.",
  msgEnterUnbanSteamID: "Please enter the SteamID (UserID) of the user to unban:",
  msgConfirmUnban: "Are you sure you want to unban the selected user?",
  msgBanComplete: "Ban complete.", 
  msgBanFailed: "Ban failed.",
  msgConfirmBan: "Are you sure you want to permanently ban (BAN) the player? This action is irreversible, and the reason is ",
  msgEnterBanReason: "Please enter the reason for the ban (permanent suspension)", 
  msgKickFailed: "Failed to kick player.",
  msgKickComplete: "Player kicked successfully.",
  msgEnterKickReason: "Please enter the reason for kicking the player",
  msgConfirmKick: "Are you sure you want to kick the player (Kick)? Reason", 
  msgNoActiveFound: "No active bans found in database.",
